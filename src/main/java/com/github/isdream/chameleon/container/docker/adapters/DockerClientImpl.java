...
public class DockerClientImpl implements Closeable, DockerClient {
    ...
    public CreateImageCmd createImageCmd() {
        return new CreateImageCmdImpl(getDockerCmdExecFactory().createCreateImageCmdExec());
    }
    ...
    public CreateContainerCmd createContainerCmd() {
        return new CreateContainerCmdImpl(getDockerCmdExecFactory().createCreateContainerCmdExec());
    }
