...
public class DockerConstants {
	...
	//
	public static final String CLIENT = DockerClientImpl.class.getName();

	//
	public static final String MODEL_PACKAGE_BASE = "com.github.dockerjava.core.command";
	
	public static final String MODEL_PACKAGE_EXTENSION = DockerClientImpl.class.getPackage().getName();
