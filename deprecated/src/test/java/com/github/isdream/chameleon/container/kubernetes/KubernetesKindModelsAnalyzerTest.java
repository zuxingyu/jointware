...
public class KubernetesKindModelsAnalyzerTest extends TestCase {
	...
	protected void setUp() throws Exception {
		kindModels = new KubernetesKindModelsAnalyzer().getKindModels();
	}
	...
	public static void main(String[] args) {
		KubernetesKindModelsAnalyzer kkma = new KubernetesKindModelsAnalyzer();
		ModelsUtils.showAllModels("Kubernetes", kkma.getKindModels());
