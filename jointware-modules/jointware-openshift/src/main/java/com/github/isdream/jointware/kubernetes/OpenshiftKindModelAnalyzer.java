 ...
 * 2018年3月2日
 */
public class OpenshiftKindModelAnalyzer extends KindModelAnalyzer {
	...
	protected Class<?> getKindClass(String kind) throws Exception {
		...
		for (String name : analyzer.getKindDesc(kind).split("-")) {
			...
			// for example:
			// here is a Typename : io.fabric8.Kubernetes.client.dsl.MixedOperation<io.fabric8.Kubernetes.api.model.ServiceAccount, io.fabric8.Openshift.api.model.ServiceAccountList, io.fabric8.Openshift.api.model.DoneableServiceAccount, io.fabric8.Openshift.client.dsl.Resource<io.fabric8.Openshift.api.model.ServiceAccount, io.fabric8.Openshift.api.model.DoneableServiceAccount>>
